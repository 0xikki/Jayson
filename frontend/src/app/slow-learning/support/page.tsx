            ...
            <div>
              <div className="mb-12">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950/50 rounded-2xl flex items-center justify-center">
                    <Building2 className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                  </div>
                  <h2 className="text-3xl md:text-4xl font-light text-foreground tracking-tight">Government Programs</h2>
                </div>
              ...
              <div className="space-y-6">
                {governmentPrograms.map((program) => (
                  <Card key={program.name} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 group">
                    <CardContent className="p-8">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-medium text-foreground mb-3">{program.name}</h3>
            ...
            <div>
              <div className="mb-12">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl md:text-4xl font-light text-foreground tracking-tight">NGOs</h2>
                </div>
                <p className="text-lg text-muted-foreground font-light">
              ...
              <div className="space-y-6">
                {ngos.map((ngo) => (
                  <Card key={ngo.name} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 group">
                    <CardContent className="p-8">
                      <div className="flex items-start gap-4">
                        <div className="w-10 h-10 bg-emerald-50 dark:bg-emerald-950/50 rounded-xl flex items-center justify-center flex-shrink-0 mt-1 transition-colors group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-medium text-foreground mb-3">{ngo.name}</h3>
