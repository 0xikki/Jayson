...
const GetHelpPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      {/* Emergency Contacts */}
      <section className="px-4 py-12 bg-blue-50/50 dark:bg-blue-950/30 border-y border-blue-100">
            ...
            {emergencyContacts.map((contact, index) => (
              <Card key={index} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1">
                <CardContent className="pt-8 pb-8 text-center">
                  ...
                  <p className="text-muted-foreground/80 text-xs">Contact: {contact.contact}</p>
                </CardContent>
              </Card>
            ))}
          </div>
            ...
            {recoverySteps.map((step) => {
              ...
              return (
                <Card
                  ...
                  } ${isCompleted ? 'bg-blue-50/30 border-blue-200 dark:border-blue-800' : ''}`}
                >
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-grow">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="flex items-center text-sm text-muted-foreground/80 font-light ml-4">
                        ...
                        {!isCompleted && (
                          <Button
                            ...
                            className="bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 text-white transition-all duration-200"
                          >
                            Mark as Complete
                          </Button>
                        )}
              ...
              return (
                <Card key={index} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1">
                  <CardHeader>
                    ...
                    <CardTitle className="text-xl text-center text-foreground">{option.title}</CardTitle>
                  ...
                  <CardContent>
                      ...
                      <ul className="space-y-2">
                        {option.benefits.map((benefit, benefitIndex) => (
                          <li key={benefitIndex} className="flex items-center">
                            <CheckCircle className="text-blue-600 dark:text-blue-400 mr-2 flex-shrink-0" size={16} />
                    ...
                    <div>
                      <h4 className="font-medium text-foreground mb-3">Available in:</h4>
                      <div className="flex flex-wrap gap-2">
                        {option.locations.map((location, locationIndex) => (
                          <span key={locationIndex} className="flex items-center bg-blue-50 px-3 py-1.5 rounded-full text-xs text-muted-foreground">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-border bg-card/80 backdrop-blur-sm">
            <CardContent className="p-10 text-center">
              ...
              <div className="mb-8">
                <div className="text-5xl font-light text-blue-600 dark:text-blue-400 mb-4">
              ...
              {completedSteps.length === recoverySteps.length ? (
                <div>
                  <CheckCircle className="mx-auto mb-4 text-blue-600 dark:text-blue-400" size={48} />
                  <h3 className="text-2xl font-medium text-foreground mb-4">Congratulations!</h3>
