...
export default function AssessmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {causes.map((cause) => {
              ...
              return (
                <Card key={cause.title} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1">
                  <CardHeader>
                    ...
                    <CardTitle className="text-2xl text-center font-medium text-foreground">{cause.title}</CardTitle>
                    <div className="text-center text-sm text-blue-600 dark:text-blue-400 font-medium mt-2">{cause.percentage}% of cases</div>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2.5">
                      {cause.factors.map((factor, index) => (
                        <li key={index} className="flex items-center text-muted-foreground text-sm group">
      ...
      <section className="px-4 py-20 bg-muted/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <Card className="border-blue-200 dark:border-blue-800 bg-blue-50/50 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            {selfAssessmentQuestions.map((question, index) => (
              <Card key={index} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-blue-50 rounded-xl flex items-center justify-center flex-shrink-0 text-blue-600 dark:text-blue-400 font-medium">
                      {index + 1}
                    </div>
                    <p className="text-muted-foreground leading-relaxed pt-1">{question}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
            ...
            {warningSigns.map((category, index) => (
              <Card key={index} className="border-border bg-card/80 backdrop-blur-sm transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-center text-foreground">{category.category}</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3">
                    {category.signs.map((sign, signIndex) => (
                      <li key={signIndex} className="flex items-start group">
                        <CheckCircle className="text-blue-600 dark:text-blue-400 mr-2 flex-shrink-0 mt-0.5 transition-transform group-hover:scale-110" size={16} />
                        <span className="text-muted-foreground text-sm leading-relaxed">{sign}</span>
                      </li>
                    ))}
                  </ul>
                </CardContent>
            ...
            <CardContent className="p-10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-border bg-card/80">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-medium text-foreground mb-3">Understanding the Problem</h3>
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      Learn more about gambling addiction, its causes, and effects to better understand what you&apos;re facing.
                    </p>
                    <div className="flex flex-col gap-2">
                      <Button asChild variant="outline" className="border-blue-200 dark:border-blue-800 hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-all duration-200">
                ...
                <Card className="border-border bg-card/80">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-medium text-foreground mb-3">Get Support Now</h3>
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      Connect with resources, support groups, and professional help to start your recovery journey today.
                    </p>
                    <div className="flex flex-col gap-2">
                      <Button asChild className="bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 text-white transition-all duration-200 hover:scale-105">
      ...
      <section className="px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="border-blue-200 dark:border-blue-800 bg-blue-50/30 dark:bg-blue-950/20 backdrop-blur-sm">
            <CardContent className="p-8">
              <h3 className="text-2xl font-medium text-foreground mb-4">Need Immediate Support?</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="inline-flex items-center justify-center px-8 py-4 bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 text-white rounded-lg font-medium transition-all duration-200 hover:scale-105"
                >
                  Call GA Philippines: 0917-509-4080
                </a>
                <a
                  href="tel:+639178998727"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-blue-600 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-lg font-medium transition-all duration-200 hover:scale-105"
                >
